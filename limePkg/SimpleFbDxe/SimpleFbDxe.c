...
)
{
    ...
    UINT32              SimpleFbFrameBufferAddr     = FixedPcdGet32(PcdMipiFrameBufferAddress);
    UINT32              SimpleFbFrameBufferWidth    = FixedPcdGet32(PcdMipiFrameBufferWidth);
    UINT32              SimpleFbFrameBufferHeight   = FixedPcdGet32(PcdMipiFrameBufferHeight);
