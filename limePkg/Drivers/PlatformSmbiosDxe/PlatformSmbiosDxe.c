...
CHAR8 mBiosVersion[128] = "edk2-lime";
...
CHAR8 mCpuName[128] = "Qualcomm Snapdragon 662";

CHAR8 *mProcessorInfoType4Strings[] = {
    "BGA-1156", "Qualcomm", "Snapdragon 662", NULL};
...
CHAR8 *mOemStringsType11Strings[] = {
    "https://github.com/Robotix22/edk2-lime", NULL};
    ...
    IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE *SystemTable)
{
  ...
  AsciiSPrint(
      mBiosVersion, sizeof(mBiosVersion), "edk2-lime %s",
